...
// GetAllSurveyResponses provides a mock function with given fields: orgID, appID, surveyID, startDate, endDate, limit, offset
func (_m *Storage) GetAllSurveyResponses(orgID *string, appID *string, surveyID *string, startDate *time.Time, endDate *time.Time, limit *int, offset *int) ([]model.SurveyResponse, error) {
	ret := _m.Called(orgID, appID, surveyID, startDate, endDate, limit, offset)

	var r0 []model.SurveyResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(*string, *string, *string, *time.Time, *time.Time, *int, *int) ([]model.SurveyResponse, error)); ok {
		return rf(orgID, appID, surveyID, startDate, endDate, limit, offset)
	}
	if rf, ok := ret.Get(0).(func(*string, *string, *string, *time.Time, *time.Time, *int, *int) []model.SurveyResponse); ok {
		r0 = rf(orgID, appID, surveyID, startDate, endDate, limit, offset)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.SurveyResponse)
		}
	...
	if rf, ok := ret.Get(1).(func(*string, *string, *string, *time.Time, *time.Time, *int, *int) error); ok {
		r1 = rf(orgID, appID, surveyID, startDate, endDate, limit, offset)
	} else {
		r1 = ret.Error(1)
	}
...
// GetSurveys provides a mock function with given fields: orgID, appID, surveyIDs, surveyTypes, limit, offset, groupIDs
func (_m *Storage) GetSurveys(orgID string, appID string, surveyIDs []string, surveyTypes []string, limit *int, offset *int, groupIDs []string) ([]model.Survey, error) {
	ret := _m.Called(orgID, appID, surveyIDs, surveyTypes, limit, offset, groupIDs)

	var r0 []model.Survey
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, []string, []string, *int, *int, []string) ([]model.Survey, error)); ok {
		return rf(orgID, appID, surveyIDs, surveyTypes, limit, offset, groupIDs)
	}
	if rf, ok := ret.Get(0).(func(string, string, []string, []string, *int, *int, []string) []model.Survey); ok {
		r0 = rf(orgID, appID, surveyIDs, surveyTypes, limit, offset, groupIDs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.Survey)
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, []string, []string, *int, *int, []string) error); ok {
		r1 = rf(orgID, appID, surveyIDs, surveyTypes, limit, offset, groupIDs)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *Storage) GetUserSurveyResponses(orgID *string, appID *string, userID *string, surveyIDs []string, surveyTypes []string, startDate *time.Time, endDate *time.Time, limit *int, offset *int) ([]model.SurveyResponse, error) {
...
func (_m *Storage) UpdateSurvey(survey model.Survey) error {
	ret := _m.Called(survey)
