...
func NewApplication(version string, build string, storage interfaces.Storage, notifications interfaces.Notifications, groups interfaces.Groups, logger *logs.Logger) *Application {
